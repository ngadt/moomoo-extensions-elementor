...
class Elementor_Tab_Projects_Widget extends \Elementor\Widget_Base {
	...
	public function get_name() {
		return 'moomoo-tab-projects';
	}
	
	public function get_title() {
		return __( 'Moomoo Tab Projects', 'moomoo-extensions-elementor' );
	}
	...
	public function ndt_enqueue_scripts() {
		...
		wp_enqueue_style('mm-tab-projects-widget', MM_EXT_ASSET_URL .'/css/tab-projects-widget.css', array(), time());		
		wp_enqueue_script('mm-tab-projects-widget',MM_EXT_ASSET_URL .'/js/tab-projects-widget.js',array('jquery'), time(), true);
	...
	private function register_tab_bar_style_setting(){
		$this->start_controls_section(
			'section_tab_bar_style',
			[
				'label' => __( 'Tab Bar', 'moomoo-extensions-elementor' ),
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .elementor-tab-projects-widget ul.tab-bar li a',
				
				
			]
		);
	
		$this->start_controls_tabs( 'tab_bar_colors' );
		...
		$this->add_control(
			...
			[
				...
				'default' => '#000',
				'selectors' => [
					'{{WRAPPER}} .elementor-tab-projects-widget .tab-bar-box ul.tab-bar li a' => 'color: {{VALUE}}'
				]
		...
		$this->add_control(
			...
			[
				...
				'default' => '#2196f3',
				'selectors' => [
					'{{WRAPPER}} .elementor-tab-projects-widget .tab-bar-box ul.tab-bar li:hover a' => 'color: {{VALUE}}'
				]
		...
		$this->add_control(
			'tab_bar_color_active',
			[
				
				'label'=>'Tab Bar Active',
				'type' => Controls_Manager::COLOR,				
				'default' => '#2196f3',
				'selectors' => [
					'{{WRAPPER}} .elementor-tab-projects-widget .tab-bar-box ul.tab-bar li.active a' => 'color: {{VALUE}}'
				]
	...
	public function register_layout_section_controls(){
		...
		$this->add_control(
			...
			[
				...
				'default' => '#fff',
				'selectors' => [
					'{{WRAPPER}} .elementor-tab-projects-widget .info-over, {{WRAPPER}} .elementor-tab-projects-widget .info-over h3.title' => 'color: {{VALUE}}'
				]
		...
		$this->add_control(
			...
			[
				...
				'default' => '#000',
				'selectors' => [
					'{{WRAPPER}} .elementor-tab-projects-widget .info-over' => 'background-color: {{VALUE}}'
				]
		...
		$this->add_group_control(
			Group_Control_Typography::get_type(),
			[
				'label' => 'Title Post Style',
				'name' => 'title_style',
				'scheme' => Schemes\Typography::TYPOGRAPHY_1,				
				'selector' => '{{WRAPPER}} .elementor-tab-projects-widget .info-over h3',
		...
		$this->add_group_control(
			...
			[
				...
				'scheme' => Schemes\Typography::TYPOGRAPHY_1,				
				'selector' => '{{WRAPPER}} .elementor-tab-projects-widget .info-over .meta-data',
		...
		$this->add_group_control(
			...
			[
				...
				'scheme' => Schemes\Typography::TYPOGRAPHY_1,				
				'selector' => '{{WRAPPER}} .elementor-tab-projects-widget .info-over .view-more',
		...
		$this->add_control(
			...
			[
				...
				'default' => '#fff',
				'selectors' => [
					'{{WRAPPER}} .elementor-tab-projects-widget .info-over .view-more:hover' => 'color: {{VALUE}}'
				]
	...
	public function register_pagination_section_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => 'center',
				'selectors' => [
					'{{WRAPPER}} .elementor-tab-projects-widget .moomoo-pagenavi ul.page-navi' => 'text-align: {{VALUE}};',
				],
				'condition' => [
					'pagination_type!' => '',
				],
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .elementor-tab-projects-widget .moomoo-pagenavi ul.page-navi li a',
				'global' => [
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .elementor-tab-projects-widget .moomoo-pagenavi ul.page-navi li a' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .elementor-tab-projects-widget .moomoo-pagenavi ul.page-navi li a:hover' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .elementor-tab-projects-widget .moomoo-pagenavi ul.page-navi li.active a' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .elementor-tab-projects-widget .moomoo-pagenavi ul.page-navi li a' => 'padding: 0  {{SIZE}}{{UNIT}}',
				],
			]
		);
	...
	protected function register_controls() {
		...
		$this->register_tab_bar_style_setting();
		$this->register_meta_data_controls();
		$this->register_pagination_section_controls();

	}
	private function get_post_by_category($category_id, $post_per_page, $pagination_limit_project){
	...
	protected function render() {
		...
		<div class="moomoo-elementor-extension elementor-tab-projects-widget">
			<div class="elementor-row">
				<div class="tab-bar-box">
					<span class="tab-selected">All</span>
					<ul class="tab-bar">
						<li data-id="tab-all" class="active"><a href="#">All</a></li>
						<?php 
						$taxonomy_name = 'category';
						$ids_cat_child = get_term_children( $category_id, $taxonomy_name);
						foreach ($ids_cat_child as $id_cat_child) {
							$term = get_term_by( 'id', $id_cat_child, $taxonomy_name );
							?>
							<li data-id="tab-<?php echo $id_cat_child ?>"><a href="#"><?php echo $term->name;  ?></a></li>
							<?php
						}
						 ?>
					</ul>
				...
				<div class="tab-content">
					<div>
						<?php
							...
							$posts = $this->get_post_by_category($category_id, $post_per_page, $pagination_limit_project);
							$count_posts = count($this->get_post_by_category($category_id, -1, -1));
							$current_page = ( get_query_var( 'paged' ) ) ? get_query_var( 'paged' ) : 1;
							//var_dump('$post_per_page='.$post_per_page);
							//var_dump('$count_posts='.$count_posts);
							$page_numbers = ceil($count_posts/$post_per_page);
								...
								$html ='';
									...
									foreach ($posts as $post) {
										...
										$ids_cat = get_the_category($ID_post);
										$class_cat = 'tab-all ';
										foreach ($ids_cat as $id_cat) {
											$class_cat .="tab-".$id_cat->term_id.' ';
										}
										...
										$html .= '<div class="elementor-column elementor-col-'.$column.' '.$class_cat.'">';
